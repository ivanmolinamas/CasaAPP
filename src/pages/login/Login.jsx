...
export default function Login() {
  ...
  // Validamos que el nombre de usuario y la contraseña no contengan caracteres peligrosos
  const validateInput = (user, password) => {
    // Valida que el nombre de usuario y la contraseña no contengan caracteres peligrosos
  ...
  const handleLogin = async (e) => {
    ...
    const validationError = validateInput(user, password);
    if (validationError) {
    ...
    login(sanitizedUser, sanitizedPassword)
      .then((data) => {
    ...
    return (
      <div className={classes.container}>
        <div className={classes.loginContainer}>
          ...
          <div className={classes.Content} value="tab1">
            <p className={classes.Text}>Acceso con tu cuenta</p>
            <fieldset className={classes.Fieldset}>
              <label className={classes.Label} htmlFor="name">
                Usuario
